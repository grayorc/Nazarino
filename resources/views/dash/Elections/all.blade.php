        ...
        <section class="container px-4 mx-auto flex-grow-1">
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex items-center mt-4 gap-x-3">
                    <button class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-SecondaryBlack dark:bg-PrimaryBlack hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
                    ...
                    <a href="{{ route('elections.create') }}">
                        <button class="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors border-2 border-primaryColor duration-200 bg-primaryColor rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-primaryColor dark:hover:bg-transparent dark:hover:text-primaryColor dark:bg-primaryColor">
    ...
    {{--                    --}}{{--         if empty           --}}
                        @if($elections->isEmpty())
                            ...
                            <div class="flex flex-col w-full max-w-sm px-4 mx-auto">
                                ...
                                <p class="mt-2 text-gray-500 dark:text-gray-400">شما هیچ نظرسنجی یافت نشد. لطفاً دوباره امتحان کنید یا یک نظرسنجی جدید ایجاد کنید.</p>
                        ...
                        <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-PrimaryBlack">
                                    @foreach ($elections as $election)
{{--row--}}
                                <tr>
                                    <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                        <div>
                                            <h2 class="font-medium text-gray-800 dark:text-white ">{{ $election->title }}</h2>
                                            <p class="text-sm font-normal text-gray-600 dark:text-gray-400">{{ $election->description }}</p>
                                        </div>
                                    </td>
                                    <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                        <div class="inline px-3 py-1 text-sm font-normal rounded-full text-emerald-500 gap-x-2 bg-emerald-100/60 dark:bg-SecondaryBlack">
            ...
            <div class="mt-6 sm:flex sm:items-center sm:justify-between ">
                ...
                <div class="flex items-center mt-4 gap-x-4 sm:mt-0">
                    <a href="#" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-white border rounded-md sm:w-auto gap-x-2 hover:bg-gray-100 dark:bg-PrimaryBlack dark:text-gray-200 dark:border-gray-700 dark:hover:bg-SecondaryBlack">
