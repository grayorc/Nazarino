<x-min-layout>
    ...
    <div class="flex relative min-h-screen bg-gray-100 dark:bg-PrimaryBlack">
        <section class="container px-2 md:px-4 mx-auto flex-grow-1 w-full mt-10">
...
{{--                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">این نظرسنجی ها از قبل ایجاد شده اند</p>--}}
                ...
                <div class="flex flex-col sm:flex-row items-center mt-4 gap-y-2 sm:gap-y-0 gap-x-3">
                    @can('excel-export')
                    <a href="{{ route('elections.export', request()->query()) }}" class="w-full sm:w-auto">
                    ...
                    @else
                    <button disabled title="شما دسترسی لازم برای خروجی اکسل را ندارید" class="flex items-center justify-center w-full sm:w-auto px-5 py-2 text-sm text-gray-500 transition-colors duration-200 bg-gray-100 border rounded-lg gap-x-2 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700 cursor-not-allowed">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_3098_154395)">
                                <path d="M13.3333 13.3332L9.99997 9.9999M9.99997 9.9999L6.66663 13.3332M9.99997 9.9999V17.4999M16.9916 15.3249C17.8044 14.8818 18.4465 14.1806 18.8165 13.3321C19.1866 12.4835 19.2635 11.5359 19.0351 10.6388C18.8068 9.7417 18.2862 8.94616 17.5555 8.37778C16.8248 7.80939 15.9257 7.50052 15 7.4999H13.95C13.6977 6.52427 13.2276 5.61852 12.5749 4.85073C11.9222 4.08295 11.104 3.47311 10.1817 3.06708C9.25943 2.66104 8.25709 2.46937 7.25006 2.50647C6.24304 2.54358 5.25752 2.80849 4.36761 3.28129C3.47771 3.7541 2.70656 4.42249 2.11215 5.23622C1.51774 6.04996 1.11554 6.98785 0.935783 7.9794C0.756025 8.97095 0.803388 9.99035 1.07431 10.961C1.34523 11.9316 1.83267 12.8281 2.49997 13.5832" stroke="currentColor" stroke-width="1.67" stroke-linecap="round" stroke-linejoin="round"/>
                            </g>
                                    ...
                                    <tr>
                                        <td class="px-4 py-4 text-sm font-medium">
                                            <div>
                                                ...
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400 break-words">{{ Str::limit($election->description, '20') }}</p>
                                            </div>
                                        </td>
    ...
    {{--                                        </div>--}}
                                        ...
                                        <td class="relative px-4 py-4 text-sm whitespace-nowrap">
                                            ...
                                            <button @click="deleteModalOpen = true; electionToDelete = {{ $election->id }}" class="px-1 py-1 text-red-700 transition-colors duration-200 rounded-lg hover:bg-gray-700">
        ...
        <div x-show="deleteModalOpen" class="fixed top-0 left-0 z-[99] flex items-center justify-center w-screen h-screen" dir="ltr" x-cloak>
            ...
            <div x-show="deleteModalOpen"
                ...
                <div class="flex items-center justify-between pb-3">
                    <h3 class="text-lg font-semibold dark:text-white">حذف نظرسنجی</h3>
                ...
                <div class="relative w-auto pb-8">
                    <p class="dark:text-gray-300">آیا از حذف این نظرسنجی اطمینان دارید؟ این عمل غیرقابل بازگشت است.</p>
                </div>
                <div class="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2">
                    ...
                    <form :action="`{{ url('dashboard/elections') }}/${electionToDelete}`" method="POST" class="m-0">
                        @csrf
                        @method('DELETE')
                        <button
                            type="submit"
