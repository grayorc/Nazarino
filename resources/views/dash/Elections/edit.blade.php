            ...
            <form action="{{ route('elections.update', $election) }}" method="post" class="flex flex-col mt-6 bg-SecondaryBlack rounded-lg p-5" enctype="multipart/form-data">
                ...
                <div class="flex flex-row">
                    <div class="w-full">
                        ...
                        <input type="text" name="title" id="title" value="{{ $election->title }}" placeholder="عنوان نظرسنجی را بنویسید" class="block mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-PrimaryBlack dark:text-gray-300 dark:focus:border-blue-300 {{ $errors->has('title') ? 'border-red-500 focus:border-red-500' : '' }}" />
                ...
                <div class="mt-5">
                    <div class="flex flex-row items-center space-x-4">
                        <div class="flex flex-row items-center space-x-4">
                            ...
                            <div dir="ltr" x-data="{ switchOn: {{ $election->end_date ? 'true' : 'false' }} }" class="flex items-center justify-center space-x-2">
                ...
                initCalendar() {
                    ...
                    @if($election->end_date)
                        this.datePickerYear = {{ verta($election->end_date)->year }};
                        this.datePickerMonth = {{ verta($election->end_date)->month - 1 }};
                        this.datePickerDay = {{ verta($election->end_date)->day }};
                ...
                <div class="mt-5">
                    <div class="flex ml-auto">
                        <div dir="ltr" x-data="{ switchOn: {{ $election->has_comment ? 'true' : 'false' }} }" class="flex items-center justify-center space-x-2">
                ...
                <div class="mt-5">
                    <div class="flex ml-auto">
                        <div dir="ltr" x-data="{ switchOn: {{ $election->is_public ? 'true' : 'false' }} }" class="flex items-center justify-center space-x-2">
