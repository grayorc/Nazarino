<aside class="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-PrimaryBlack dark:border-gray-700">
    <a href="#" class="mx-auto">
        <img class="w-auto h-6 sm:h-7" src="dist/img/logo.png" alt="">
    </a>
